   	...
   	$ids = array();
		...
		foreach ($xml->venue as $venue) {
			...
			if ($this->options["include_meta_data"]=="1"){
				...
				foreach(array('name','street','city','province_state','country','postal_code','description','community','directions','longitude','latitude','primary_phone_number','photo_url','photo_url_root','updated_at') as $field){
